...
SET SPECTRUM_PATH=%WORKSPACE%\Qt5.4.1-x86-msvc2012_opengl
echo %%SPECTRUM_PATH%%: %SPECTRUM_PATH% >> %LOG_FILEPATH%
echo %%SPECTRUM_PATH%%: %SPECTRUM_PATH%
mkdir -p %SPECTRUM_PATH%

SET QT_DEBUG_DIRECTORY=Qt5.4.1-x86-msvc2012_opengl_debug
...
SET QT_RELEASE_DIRECTORY=Qt5.4.1-x86-msvc2012_opengl_release
