...
/c/Program\ Files/7-Zip/7z a -tzip -mx9 "$SPECTRUM_PATH".zip -r
"$SPECTRUM_PATH"/*
/c/Program\ Files/7-Zip/7z a -t7z -mx9 "$SPECTRUM_PATH".7z -r
"$SPECTRUM_PATH"/*
...
/c/Program\ Files/7-Zip/7z a -tzip -mx9 "$DEBUG_DIRECTORY_NAME".zip -r
"$DEBUG_DIRECTORY_NAME"/*
/c/Program\ Files/7-Zip/7z a -t7z -mx9 "$DEBUG_DIRECTORY_NAME".7z -r
"$DEBUG_DIRECTORY_NAME"/*
...
/c/Program\ Files/7-Zip/7z a -tzip -mx9 "$RELEASE_DIRECTORY_NAME".zip -r
"$RELEASE_DIRECTORY_NAME"/*
/c/Program\ Files/7-Zip/7z a -t7z -mx9 "$RELEASE_DIRECTORY_NAME".7z -r
"$RELEASE_DIRECTORY_NAME"/*
