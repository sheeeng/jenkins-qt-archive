...
set QT_PATH=C:\Qt\Qt5.4.1-x86-msvc2012_opengl\5.4\msvc2012_opengl
echo %%QT_PATH%%: %QT_PATH% >> %LOG_FILEPATH%
echo %%QT_PATH%%: %QT_PATH%

SET ARCHIVE_DIRECTORY_NAME=%WORKSPACE%\Qt5.4.1-x86-msvc2012_opengl
echo %%ARCHIVE_DIRECTORY_NAME%%: %ARCHIVE_DIRECTORY_NAME% >> %LOG_FILEPATH%
echo %%ARCHIVE_DIRECTORY_NAME%%: %ARCHIVE_DIRECTORY_NAME%
mkdir %ARCHIVE_DIRECTORY_NAME%

SET ARCHIVE_DEBUG_DIRECTORY_NAME=Qt5.4.1-x86-msvc2012_opengl_debug
...
SET ARCHIVE_RELEASE_DIRECTORY_NAME=Qt5.4.1-x86-msvc2012_opengl_release
...
robocopy /is /copyall /njs /np /tee /log+:%LOG_FILEPATH% "%QT_PATH%\bin" "%ARCHIVE_DIRECTORY_NAME%" Qt5Cored.dll Qt5Core.dll
robocopy /is /copyall /njs /np /tee /log+:%LOG_FILEPATH% "%QT_PATH%\bin" "%ARCHIVE_DIRECTORY_NAME%" Qt5Guid.dll Qt5Gui.dll
robocopy /is /copyall /njs /np /tee /log+:%LOG_FILEPATH% "%QT_PATH%\bin" "%ARCHIVE_DIRECTORY_NAME%" Qt5Widgetsd.dll Qt5Widgets.dll
robocopy /is /copyall /njs /np /tee /log+:%LOG_FILEPATH% "%QT_PATH%\bin" "%ARCHIVE_DIRECTORY_NAME%" Qt5Networkd.dll Qt5Network.dll
robocopy /is /copyall /njs /np /tee /log+:%LOG_FILEPATH% "%QT_PATH%\bin" "%ARCHIVE_DIRECTORY_NAME%" Qt5Qmld.dll Qt5Qml.dll
robocopy /is /copyall /njs /np /tee /log+:%LOG_FILEPATH% "%QT_PATH%\bin" "%ARCHIVE_DIRECTORY_NAME%" Qt5Quickd.dll Qt5Quick.dll
robocopy /is /copyall /njs /np /tee /log+:%LOG_FILEPATH% "%QT_PATH%\bin" "%ARCHIVE_DIRECTORY_NAME%" Qt5Xmld.dll Qt5Xml.dll
robocopy /is /copyall /njs /np /tee /log+:%LOG_FILEPATH% "%QT_PATH%\bin" "%ARCHIVE_DIRECTORY_NAME%" icudt*.dll
robocopy /is /copyall /njs /np /tee /log+:%LOG_FILEPATH% "%QT_PATH%\bin" "%ARCHIVE_DIRECTORY_NAME%" icuin*.dll
robocopy /is /copyall /njs /np /tee /log+:%LOG_FILEPATH% "%QT_PATH%\bin" "%ARCHIVE_DIRECTORY_NAME%" icuuc*.dll
robocopy /is /copyall /njs /np /tee /log+:%LOG_FILEPATH% /mir "%QT_PATH%\plugins\platforms" "%ARCHIVE_DIRECTORY_NAME%\platforms"
robocopy /is /copyall /njs /np /tee /log+:%LOG_FILEPATH% /mir "%QT_PATH%\qml\QtQml" "%ARCHIVE_DIRECTORY_NAME%\QtQml
robocopy /is /copyall /njs /np /tee /log+:%LOG_FILEPATH% /mir "%QT_PATH%\qml\QtQuick" "%ARCHIVE_DIRECTORY_NAME%\QtQuick
robocopy /is /copyall /njs /np /tee /log+:%LOG_FILEPATH% /mir "%QT_PATH%\qml\QtQuick.2" "%ARCHIVE_DIRECTORY_NAME%\QtQuick.2
