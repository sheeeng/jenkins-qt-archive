...
cp -pv $QT_PATH/bin/{Qt5OpenGLd.dll,Qt5OpenGL.dll} $ARCHIVE_DIRECTORY_NAME
cp -pv $QT_PATH/bin/{Qt5PrintSupportd.dll,Qt5PrintSupport.dll} $ARCHIVE_DIRECTORY_NAME
...
cp -pv $QT_PATH/bin/Qt5OpenGLd.dll $ARCHIVE_DEBUG_DIRECTORY_NAME
cp -pv $QT_PATH/bin/Qt5PrintSupportd.dll $ARCHIVE_DEBUG_DIRECTORY_NAME
...
cp -pv $QT_PATH/bin/Qt5OpenGL.dll $ARCHIVE_RELEASE_DIRECTORY_NAME
cp -pv $QT_PATH/bin/Qt5PrintSupport.dll $ARCHIVE_RELEASE_DIRECTORY_NAME
