...
SET DIRECTORY_NAME=%WORKSPACE%\qt5.4.1-x86-msvs2013_vc12
echo %%DIRECTORY_NAME%%: %DIRECTORY_NAME% >> %LOG_FILEPATH%
echo %%DIRECTORY_NAME%%: %DIRECTORY_NAME%
mkdir %DIRECTORY_NAME%

SET ARCHIVE_DEBUG_DIRECTORY_NAME=qt5.4.1-x86-msvs2013_vc12-debug
...
SET ARCHIVE_RELEASE_DIRECTORY_NAME=qt5.4.1-x86-msvs2013_vc12-release
